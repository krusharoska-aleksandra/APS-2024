package MergeDLLsWithoutDuplicates;
...
// притоа вметнување на дупликати не е дозволено.
//Влез:
//10
//2 4 5 7 9 11 12 15 16 17
//9
//16 1 18 19 7 8 9 3 16
//Излез:
//1 2 3 4 5 7 9 11 12 15 16 17 18

public class MerginDLLs {

    private static void merging(DLL<Integer> lista1, DLL<Integer> lista2) {
        DLLNode<Integer> helping = lista2.getFirst();

        while (helping != null) {
            DLLNode<Integer> main = lista1.getFirst();
            ...
            while (main != null) {
                ...
                if (main.element > helping.element) {
                    lista1.insertBefore(helping.element, main);
                    lista2.delete(helping);
                    flag = false;
                    break;
                }
            ...
            if (flag) {
                lista1.insertLast(helping.element);
                lista2.delete(helping);
            }
