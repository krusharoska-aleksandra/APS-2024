...
//            long sum=0;
//
//            DLL<Integer>sublist=currentList.element;
//            DLLNode<Integer>currentElement=sublist.getFirst();
//
...
//        return product;
        ...
        while (mainNode != null) {
            DLLNode<Integer> helpingNode = mainNode.element.getFirst();
            long sum = 0;
            while (helpingNode != null) {
                sum += helpingNode.element;
